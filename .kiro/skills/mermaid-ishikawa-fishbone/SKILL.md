---
name: mermaid-ishikawa-fishbone
description: 使用 Mermaid ishikawa-beta 語法製作魚骨圖（Ishikawa Diagram）。當使用者要求製作魚骨圖、路線圖解、ishikawa 圖表，或需要視覺化單車行程段落時觸發。需要 Mermaid v11.12.3+。
---
